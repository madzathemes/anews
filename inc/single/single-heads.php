<?php function anews_single_cat() {?>
  ...
  ?>
  <?php if ( false == get_theme_mod( 't_p_shares', false ) ) { $t_p_shares = esc_html__("Shares", "anews");  } else { $t_p_shares = get_theme_mod( 't_p_shares' ); } ?>
  <?php if ( false == get_theme_mod( 't_p_views', false ) ) { $t_p_views = esc_html__("Views", "anews");  } else { $t_p_views = get_theme_mod( 't_p_views' ); } ?>
  <?php if ( false == get_theme_mod( 't_c_comments', false ) ) { $t_c_comments = esc_html__("Comments", "anews");  } else { $t_c_comments = get_theme_mod( 't_c_comments' ); } ?>
...
<?php } ?>
<?php function anews_single_cat_posts() {
...
<?php function anews_single_title() {?>
  ...
  <?php } ?>
<?php } ?>
<?php function anews_single_social() {
