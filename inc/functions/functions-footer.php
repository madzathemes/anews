<?php function anews_footer_1() {?>
  <?php $option = get_option("anews_theme_options"); ?>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 footer-about">
              <h2><?php echo esc_html__('About Us', 'anews'); ?></h2>
              <p><?php echo html_entity_decode(get_theme_mod('anews_footer_about_us', 'Donec eu tellus convallis, vehicula neque sed, mattis elit. Praesent ornare, ligula in efficitur egestas, massa lacus vulputate enim')); ?> </p>
              <p><?php echo esc_html__('Contact us:', 'anews'); ?> <a class="mail" href="mailto:<?php echo esc_html(get_theme_mod('anews_footer_about_us_mail', 'info@anews.com')); ?>" target="_top"><?php echo esc_html(get_theme_mod('anews_footer_about_us_mail', 'info@anews.com')); ?></a></p>
            </div>
            <div class="col-md-5 footer-social">
              <h2><?php echo esc_html__('Follow Us', 'anews'); ?></h2>
              <?php anews_socials(); ?>
              <p><?php echo html_entity_decode(get_theme_mod('anews_footer_follow_us', 'Donec eu tellus convallis, vehicula neque sed')); ?></p>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 footer-copyright">
              <p><?php echo html_entity_decode(get_theme_mod('anews_copyright_text', 'Copyright 2017. Powered by WordPress Theme. By Madars Bitenieks')); ?></p>
            </div>
              <div class="col-md-6">
  ...
  <?php } ?>
  <?php
} add_filter('anews_footer_1','anews_footer_1'); ?>
<?php function anews_footer_2() {?>
  <?php $option = get_option("anews_theme_options"); ?>
  <?php if  (!empty($option['footer_top'])) {  ?>
    <?php if  ($option['footer_top'] == '1') {  ?>
      <div class="footer-top">
  ...
  <?php } ?>
  <?php
} add_filter('anews_footer_2','anews_footer_2');
function anews_footer_3() {?>
  <?php $option = get_option("anews_theme_options"); ?>
  <?php if  (!empty($option['footer_top'])) {  ?>
    <?php if  ($option['footer_top'] == '1') {  ?>
      <div class="footer-top">
  ...
  <?php } ?>
  <?php
} add_filter('anews_footer_3','anews_footer_3'); ?>
